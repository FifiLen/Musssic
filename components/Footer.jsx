      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div className="flex flex-col space-y-4">
          ...
          <p className="text-gray-400">
            Our festival is a unique event that combines music, art and amazing
            experiences. Join us to celebrate with us!{" "}
          </p>
          <p className="text-gray-400">
            The festival takes place from 7-9 August 2024 in Warsaw, Poland. Get
            ready for an unforgettable three days full of music and fun!{" "}
          </p>
        </div>
