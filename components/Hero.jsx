  ...
  return (
    ...
    <div className="relative grid grid-cols-12 pt-60">
      ...
      <div className='col-span-9 mt-80'>
        <div className=' '>
          <p className=' bg-orange-400/30 p-1 ml-3  w-fit font-bold tracking-tighter text-orange-500 border-2 border-orange-500'>#Headliner</p>
          <div className=' flex gap-7'>
            <h2 className='text-[10rem] font-[900] tracking-tighter text-white'>EchoVerse</h2>
            <div className=' flex justify-normal items-center gap-3 pt-36'>
            <p className='text-xl font-bold text-orange-400 tracking-tighter '>About Performer</p>
      ...
      <div className='col-span-1 text-white space-y-6 mr-6 flex justify-center items-center justify-self-end p-3 py-5 bg-orange-400/20 h-fit'>
        <div className='flex flex-col gap-3'>
          <p className='text-2xl font-bold tracking-tighter' style={{ writingMode: 'vertical-rl' }}>Buy A Ticket</p>
